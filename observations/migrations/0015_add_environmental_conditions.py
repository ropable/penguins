...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PenguinObservation.wind_direction'
        db.add_column(u'observations_penguinobservation', 'wind_direction',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PenguinObservation.wind_speed'
        db.add_column(u'observations_penguinobservation', 'wind_speed',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=1, blank=True),
                      keep_default=False)

        # Adding field 'PenguinObservation.wave_direction'
        db.add_column(u'observations_penguinobservation', 'wave_direction',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PenguinObservation.wave_height'
        db.add_column(u'observations_penguinobservation', 'wave_height',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=1, blank=True),
                      keep_default=False)

        # Adding field 'PenguinObservation.wave_period'
        db.add_column(u'observations_penguinobservation', 'wave_period',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PenguinObservation.moon_phase'
        db.add_column(u'observations_penguinobservation', 'moon_phase',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PenguinObservation.wind_direction'
        db.delete_column(u'observations_penguinobservation', 'wind_direction')

        # Deleting field 'PenguinObservation.wind_speed'
        db.delete_column(u'observations_penguinobservation', 'wind_speed')

        # Deleting field 'PenguinObservation.wave_direction'
        db.delete_column(u'observations_penguinobservation', 'wave_direction')

        # Deleting field 'PenguinObservation.wave_height'
        db.delete_column(u'observations_penguinobservation', 'wave_height')

        # Deleting field 'PenguinObservation.wave_period'
        db.delete_column(u'observations_penguinobservation', 'wave_period')

        # Deleting field 'PenguinObservation.moon_phase'
        db.delete_column(u'observations_penguinobservation', 'moon_phase')
