...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PenguinObservation.raining'
        db.add_column(u'observations_penguinobservation', 'raining',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PenguinObservation.raining'
        db.delete_column(u'observations_penguinobservation', 'raining')
