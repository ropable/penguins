...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field completed_by on 'Video'
        m2m_table_name = db.shorten_name(u'observations_video_completed_by')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('video', models.ForeignKey(orm[u'observations.video'], null=False)),
    ...
    def backwards(self, orm):
        # Removing M2M table for field completed_by on 'Video'
        db.delete_table(db.shorten_name(u'observations_video_completed_by'))
    ...
    models = {
        ...
        u'observations.video': {
            ...
            'completed_by': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'symmetrical': 'False'}),
