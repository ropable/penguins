...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Camera.camera_key'
        db.add_column(u'observations_camera', 'camera_key',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Camera.camera_key'
        db.delete_column(u'observations_camera', 'camera_key')
