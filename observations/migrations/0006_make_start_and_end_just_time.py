...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Video.start_time'
        db.alter_column(u'observations_video', 'start_time', self.gf('django.db.models.fields.TimeField')())

        # Changing field 'Video.end_time'
        db.alter_column(u'observations_video', 'end_time', self.gf('django.db.models.fields.TimeField')())

    def backwards(self, orm):

        # Changing field 'Video.start_time'
        db.alter_column(u'observations_video', 'start_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Video.end_time'
        db.alter_column(u'observations_video', 'end_time', self.gf('django.db.models.fields.DateTimeField')())
