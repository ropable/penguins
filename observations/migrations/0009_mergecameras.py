...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Step 1: Migrate observations

        SQLQuery[0] = """
UPDATE
    observations_penguinobservation
SET
    camera_id = 1,
    site_id = 1
WHERE
...
"""
        ...
        #Step 3: Migrate States

        SQLQuery[2] = """
UPDATE
    observations_penguincount
SET
    site_id = 1
WHERE
    site_id = 3
...
"""        
    ...
    def backwards(self, orm):
        #Theres no unmerging this data folks.
        pass
