...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PenguinObservation.position'
        db.add_column(u'observations_penguinobservation', 'position',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'PenguinObservation.video'
        db.add_column(u'observations_penguinobservation', 'video',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['observations.Video'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PenguinObservation.position'
        db.delete_column(u'observations_penguinobservation', 'position')
