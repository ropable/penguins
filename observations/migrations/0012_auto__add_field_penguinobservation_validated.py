...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PenguinObservation.validated'
        db.add_column(u'observations_penguinobservation', 'validated',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PenguinObservation.validated'
        db.delete_column(u'observations_penguinobservation', 'validated')
    ...
    models = {
        ...
        u'observations.camera': {
            ...
            'camera_key': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'observations.penguincount': {
            'Meta': {'ordering': "[u'-date']", 'object_name': 'PenguinCount'},
        ...
        u'observations.penguinobservation': {
            ...
            'observer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'observations'", 'to': u"orm['observations.PenguinUser']"}),
