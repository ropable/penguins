...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PenguinCount.civil_twilight'
        #db.delete_column(u'observations_penguincount', 'civil_twilight')
        pass


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PenguinCount.civil_twilight'
        raise RuntimeError("Cannot reverse this migration. 'PenguinCount.civil_twilight' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct migration        # Adding field 'PenguinCount.civil_twilight'
        db.add_column(u'observations_penguincount', 'civil_twilight',
