...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('auth_user_user_permissions','user_id','penguinuser_id')
        db.rename_column('auth_user_groups','user_id','penguinuser_id')

    def backwards(self, orm):
        db.rename_column('auth_user_user_permissions','penguinuser_id','user_id')
        db.rename_column('auth_user_groups','penguinuser_id','user_id')
