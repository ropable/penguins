...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PenguinObservation.site'
        db.add_column(u'observations_penguinobservation', 'site',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PenguinObservation.site'
        #db.delete_column(u'observations_penguinobservation', 'site_id')
        pass
