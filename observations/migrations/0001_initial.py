...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'observations_penguincount', (
            ...
            ('observer', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('civil_twilight', self.gf('django.db.models.fields.TimeField')(null=True, blank=True)),
            ('comments', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('sub_fifteen', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('zero_to_fifteen', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('fifteen_to_thirty', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('thirty_to_fourty_five', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('fourty_five_to_sixty', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('sixty_to_seventy_five', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('seventy_five_to_ninety', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('ninety_to_one_oh_five', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('one_oh_five_to_one_twenty', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('total_penguins', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        ...
        db.create_table(u'observations_video', (
            ...
            ('video_title', self.gf('django.db.models.fields.TextField')()),
        ))
    ...
    models = {
        ...
        u'observations.video': {
            ...
            'video_title': ('django.db.models.fields.TextField', [], {})
        }
    }
