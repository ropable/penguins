...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PenguinCount', fields ['observer']
        db.delete_unique(u'observations_penguincount', ['observer_id'])


        # Changing field 'PenguinCount.observer'
        db.alter_column(u'observations_penguincount', 'observer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'PenguinCount.observer'
        db.alter_column(u'observations_penguincount', 'observer_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'PenguinCount', fields ['observer']
        db.create_unique(u'observations_penguincount', ['observer_id'])
