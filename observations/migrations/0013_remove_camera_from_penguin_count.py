...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PenguinCount.camera'
        db.delete_column(u'observations_penguincount', 'camera_id')

        # Adding field 'PenguinCount.site'
        db.add_column(u'observations_penguincount', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['observations.Site']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PenguinCount.camera'
        raise RuntimeError("Cannot reverse this migration. 'PenguinCount.camera' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PenguinCount.camera'
        db.add_column(u'observations_penguincount', 'camera',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['observations.Camera']),
                      keep_default=False)

        # Deleting field 'PenguinCount.site'
        db.delete_column(u'observations_penguincount', 'site_id')
