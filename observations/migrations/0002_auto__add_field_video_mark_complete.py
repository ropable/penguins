...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.mark_complete'
        db.add_column(u'observations_video', 'mark_complete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.mark_complete'
        db.delete_column(u'observations_video', 'mark_complete')
