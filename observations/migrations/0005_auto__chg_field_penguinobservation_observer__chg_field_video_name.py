...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PenguinObservation.observer'
        db.alter_column(u'observations_penguinobservation', 'observer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['observations.PenguinUser']))

        # Changing field 'Video.name'
        db.alter_column(u'observations_video', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'PenguinObservation.observer'
        db.alter_column(u'observations_penguinobservation', 'observer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Video.name'
        db.alter_column(u'observations_video', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
