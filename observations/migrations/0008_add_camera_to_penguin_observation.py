...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PenguinObservation.camera'
        db.add_column(u'observations_penguinobservation', 'camera',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['observations.Camera'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PenguinObservation.camera'
        db.delete_column(u'observations_penguinobservation', 'camera_id')
