...
urlpatterns = [
    ...
    path(
        "videos/<int:pk>/create-observation/",
        views.PenguinObservationCreate.as_view(),
        name="penguinobservation_create",
    ),
    path(
        "videos/<int:pk>/observations/",
        views.VideoObservations.as_view(),
        name="video_observations",
    ),
    path(
        "videos/<int:pk>/complete/",
        views.VideoComplete.as_view(),
        name="video_complete",
    ),
